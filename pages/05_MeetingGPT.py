...
has_transcript = os.path.exists("./.cache/kronii.txt")
...
def get_audio_path(video_path):
    ...
    for video_type in video_types:
        audio_path = audio_path.replace(video_type, "mp3")
    return audio_path
...
def get_transcript_path(video_path):
    audio_path = video_path
    for video_type in video_types:
        audio_path = audio_path.replace(video_type, "txt")
    return audio_path
...
if video:
    ...
    with qa_tab:
        ...
        docs = retriever.invoke("When is the newbie debut?")
        st.write(docs)
